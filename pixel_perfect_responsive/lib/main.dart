      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            const Text('Sign Up to Master').fontSize(18.sp).fontWeight(FontWeight.w700).textColor(Colors.black),
            SizedBox(height: 4.h),
            Wrap(
              children: [
                const Text('Already have an account?').fontWeight(FontWeight.w700).textColor(Colors.grey).fontSize(14.sp),
                const Text('Login').fontWeight(FontWeight.w700).textColor(Colors.purple).fontSize(14.sp),
              ],
            ),
            ...
            SizedBox(height: 16.h),
            FinOSButton(text: 'Create Account', colorBackground: const Color(0xFF306EDF), onPressed: () {}),
            Row(
              children: [
                Expanded(child: const Divider(color: Colors.red,)),
                SizedBox(width: 16.w),
            ...
            FinOSButton(text: 'Google', colorBackground: const Color(0xFF306EDF), onPressed: () {}, iconPath: 'assets/icons/vietnam.svg',).padding(top: 16.h),
